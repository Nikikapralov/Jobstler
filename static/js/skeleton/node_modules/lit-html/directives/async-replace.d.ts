...
import { AsyncDirective, DirectiveParameters } from 'lit-html/async-directive.js';
 ...
 */
export declare const asyncReplace: (value: AsyncIterable<unknown>, _mapper?: Mapper<unknown> | undefined) => import("lit-html/directive.js").DirectiveResult<typeof AsyncReplaceDirective>;
export {};
